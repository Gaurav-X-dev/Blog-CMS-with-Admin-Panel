...
<div class="login-box">
  <div class="login-logo">
    <img src="<?php echo e(url('/')); ?>/admin/uploads/logo/<?php echo e(($settings->logo)?$settings->logo:'nopreview.png'); ?>" class="img" style="width:80%;">
      ...
      <form action="<?php echo e(route('admin.login')); ?>" method="post">
        ...
        <div class="input-group mb-3">
            <div class="captcha d-inline-block">
                ...
                <button type="button" class="btn btn-outline-primary btn-sm ms-2 btn-refresh">
  ...
  <h5 class="login-box-msg pt-4" style="font-size:15px;"><i class="fa fa-globe"></i> <?php echo e($settings->company_name); ?> | <i class="fa fa-phone"></i> <?php echo e($settings->mobile); ?> | <?php echo e($settings->address); ?></h5>
<!-- /.login-box -->
...
<?php /**PATH C:\xampp\htdocs\Laravel_Projects\Bookmarking\resources\views/admin/auth/index.blade.php ENDPATH**/ ?>